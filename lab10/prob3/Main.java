...
public class Main {
	...
	private static<T> boolean contains(List<? extends T> list, T t, BiPredicate<? super T,? super T> pred) {
	...
	public static boolean contains2(List<Employee> list, Employee e, BiPredicate<Employee, Employee> pred2) {
